...
<header class="flex justify-between items-center w-full px-4 py-2 bg-slate-900 text-slate-100">
    <h1><span class="font-bold text-xl">Moviebox</span> - Criar um filme</h1>
    <nav>
...
<section class="grid sm:grid-cols-3 gap-y-5">
    <div class="sm:mb-0 mb-3">
        ...
        <p id="title" class="text-sm">Cadastro de filmes</p>
    </div>
    <div class="sm:col-span-2 border p-4 bg-slate-100 rounded-lg">
        <form action="?params=inserir" method="GET" class="flex flex-col gap-2">
            <div class="text-sm">
                <label class="block" for="name">Nome</label>
                <input class="px-3 py-2 rounded border w-full" type="text" name="name" id="name">
            </div>
            <div class="text-sm">
